...
/* $Id: thread.c,v 1.5 2008/04/14 02:02:26 akatsuka Exp $ */


/*
**
**	theread_cread() スレッドの使い方
**
**
**　thread_create()でスレッドをスタートされた場合、
**　thread_join()でスレッドの終了を待つか、thread_exit()で自らスレッドを終了させなければならない
**  thread_join()でスレッドの終了を待つ場合、thread_exit()は呼び出してはいけない
**
*/
